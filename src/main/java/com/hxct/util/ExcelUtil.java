...
public class ExcelUtil
{
	...
	public static ArrayList<Map<Integer, Object>> readExcelByID(File file)
	{
		if(file == null)
		{
			return null;
		...
		{
			//处理ecxel2007  
			return readExcel2007ByID(file);
		}
		else
		{
			//处理ecxel2003  
			return readExcel2003ByID(file);
		}
	}
	/*  
...
//									println(i + "行" + j + " 列 is default type");
	...
	public static ArrayList<Map<Integer, Object>> readExcel2003ByID(File file)
	{
		try
		{
			ArrayList<Map<Integer, Object>> rowList
					= new ArrayList<Map<Integer, Object>>();
			Map<Integer, Object> colList;
			HSSFWorkbook wb = new HSSFWorkbook(new FileInputStream(file));
			HSSFSheet sheet = wb.getSheetAt(0);
			HSSFRow row;
			HSSFCell cell;
			...
			{
				row = sheet.getRow(i);
				colList = new HashMap<Integer, Object>();
				if(row == null)
				{
					//当读取行为空时  
					if(i != sheet.getPhysicalNumberOfRows())
...
//			System.out.println("exception");
	...
	public static ArrayList<Map<Integer, Object>> readExcel2007ByID(File file)
	{
		try
		{
			ArrayList<Map<Integer, Object>> rowList
