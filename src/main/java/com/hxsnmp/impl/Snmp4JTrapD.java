...
//import com.hxrd.fault.AlertReceive;
//import com.hxrd.server.EventProxy;
import com.hxsnmp.api.ISnmpTrapD;
import com.hxsnmp.api.ISnmpTrapHandler;
...
public class Snmp4JTrapD implements ISnmpTrapD, CommandResponder {
	...
	public void processPdu(CommandResponderEvent event) {
		try {
			...
			ISnmpTrapMsg trapMsg = new Snmp4JTrapMsg(event.getPeerAddress(),
					pdu);
			logger.info("TrapMessage Created:" + trapMsg.toMap().toString());
//			EventProxy.getInstance().processTrap(trapMsg.getPeerAddr(),
//					trapMsg.getTrapOid(), trapMsg.toMap());
//			AlertReceive.getInstance().recvMessage(trapMsg);
